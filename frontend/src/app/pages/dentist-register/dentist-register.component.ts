    ...
    <div class="auth-page">
      <div class="auth-card fade-in">
        <div class="auth-header">
          ...
          <p>Create an account to join dental camps and screen patients</p>
        </div>
        ...
        <form *ngIf="!success" (ngSubmit)="register()">
          ...
          <button type="submit" class="btn btn-primary btn-lg" style="width: 100%;" [disabled]="loading">
            {{ loading ? 'Creating Account...' : 'Register as Dentist' }}
          </button>
...
export class DentistRegisterComponent {
    ...
    register(): void {
        ...
        this.api.registerDentistAccount(this.form).subscribe({
            next: (res) => {
                this.loading = false;
                this.success = true;
            },
